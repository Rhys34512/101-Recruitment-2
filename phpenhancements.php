...
<!-- Container which holds the navigation bar -->
   ...
   <h2>Manager Login System</h2>
   <p>Enhancement Link: <a href="login.php">login.php</a>
   ...
   <p>Enhancement Link: <a href="careers.php">careers.php</a></p>
   ...
   <p>Enhancement Link: <a href="faq.php">faq.php</a></p>
